...
pp.create_measurement(net, "q", "bus", -.286, 10., b2)
...
b2= pp.create_bus(net, name="bus 2",vn_kv=1., index=2)
b3= pp.create_bus(net, name="bus 3",vn_kv=1., index=3)
b4= pp.create_bus(net, name="bus 4",vn_kv=1., index=4)
b5= pp.create_bus(net, name="bus 5",vn_kv=1., index=5)
b6= pp.create_bus(net, name="bus 6",vn_kv=1., index=6)
'''